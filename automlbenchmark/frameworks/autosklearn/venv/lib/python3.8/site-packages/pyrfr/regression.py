...
class forest_opts(object):
    ...
    * `tree_opts` : `rfr::trees::tree_options< num_t, response_t, index_t >`  
    ...
    compute_law_of_total_variance = _swig_property(_regression.forest_opts_compute_law_of_total_variance_get, _regression.forest_opts_compute_law_of_total_variance_set)
